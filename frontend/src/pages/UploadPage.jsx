...
export default function UploadPage() {
  ...
  async function handleAnalyze() {
    ...
    try {
      ...
      setAgentStep(AGENTS.length) // all done
      ...
      setLoading(false)
      setAgentStep(-1)
      setError('Backend unreachable. Please make sure the server is running on port 8000.')
    }
  }
    ...
    <div style={{ minHeight: '100vh', background: 'var(--bg-primary)', padding: '2rem' }}>
      <div style={{ maxWidth: '860px', margin: '0 auto' }}>
        ...
        <div className="glow-card" style={{ padding: '2rem', marginBottom: '1.5rem' }}>
          ...
          {/* Attendees + Duration row */}
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 180px', gap: '1rem', marginBottom: '1.25rem' }}>
            <div>
              <label style={labelStyle}>Attendees <span style={{ color: 'var(--text-muted)', fontWeight: 400 }}>(comma separated)</span></label>
              <input
                value={attendees}
          ...
          <div style={{ marginBottom: '1.5rem' }}>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '0.5rem' }}>
              ...
              <button
                onClick={() => { setTranscript(DEMO); setTitle('Q3 Product Planning'); setAttendees('Alice, Bob, Carol, David'); setDuration(45) }}
                style={{
            ...
            <textarea
              ...
              rows={14}
              style={{ ...inputStyle, resize: 'vertical', fontFamily: 'JetBrains Mono, monospace', fontSize: '0.82rem', lineHeight: '1.6' }}
            />
          </div>
